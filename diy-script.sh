...
sed -i "s|firmware_repo.*|firmware_repo 'https://github.com/qazz-shyper/OP-build'|g" package/luci-app-amlogic/root/etc/config/amlogic
...
sed -i "s/${orig_version}/R${date_version} by Shyper/g" package/lean/default-settings/files/zzz-default-settings
